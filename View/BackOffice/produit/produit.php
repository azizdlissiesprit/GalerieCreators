...
<body>
    ...
    <script>
        ...
        function validateInput() {
                       ...
                       var inputValue2 = document.getElementById("prix_produit").value;
                       ...
                       if (!(/^[0-9]+$/.test(inputValue2) && parseInt(inputValue2) > 0))  {
                           
                           alert("INValid input");
                           document.getElementById("prix_produit").value = '';
                       } 
                   }
    ...
    <script>
         function valider_formulaire_update() {
            var nom = document.getElementById("nom_produit").value;
